...
wasm32_FILES = $(CORE_FILES) wasm32-gen.c wasm32-locals.c wasm32-stackify.c wasm32-link.c tccwasm.c

TCCDEFS_H$(subst yes,,$(CONFIG_predefs)) = tccdefs_.h

# libtcc sources
# wasm32-locals.c and wasm32-stackify.c are included by wasm32-gen.c
LIBTCC_SRC = $(filter-out tcc.c tcctools.c wasm32-locals.c wasm32-stackify.c,$(filter %.c,$($T_FILES)))
...
LIBTCC_INC = $(filter %.h %-gen.c %-link.c %-locals.c %-stackify.c,$($T_FILES))
